...
func (m *MockProviderRepository) WithTx(tx postgres.DBTX) repository.ProviderRepository {
	m.ctrl.T.Helper()
...
func (mr *MockProviderRepositoryMockRecorder) WithTx(tx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "WithTx", reflect.TypeOf((*MockProviderRepository)(nil).WithTx), tx)
}
