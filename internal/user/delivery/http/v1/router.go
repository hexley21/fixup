...
func NewRouter(authService service.AuthService, userService service.UserService, authJwt jwt.AuthJwt) *v1Router {
	return &v1Router{
...
func (v1r *v1Router) MapV1Routes(echo *echo.Echo) *echo.Group {
	...
	auth.NewAuthHandler(v1r.authService, v1r.authJwt).MapRoutes(v1Group)
