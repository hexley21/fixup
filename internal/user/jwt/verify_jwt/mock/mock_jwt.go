...
// Source: internal/user/jwt/verify_jwt/jwt.go
//
// Generated by this command:
//
//	mockgen -source=internal/user/jwt/verify_jwt/jwt.go -destination=internal/user/jwt/verify_jwt/mock/mock_jwt.go
//

// Package mock_verify_jwt is a generated GoMock package.
package mock_verify_jwt

import (
	reflect "reflect"

	verify_jwt "github.com/hexley21/fixup/internal/user/jwt/verify_jwt"
...
func (m *MockJWTManager) VerifyJWT(tokenString string) (verify_jwt.VerifyClaims, *rest.ErrorResponse) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "VerifyJWT", tokenString)
	ret0, _ := ret[0].(verify_jwt.VerifyClaims)
	ret1, _ := ret[1].(*rest.ErrorResponse)
	return ret0, ret1
}
...
// VerifyJWT mocks base method.
func (m *MockJWTVerifier) VerifyJWT(tokenString string) (verify_jwt.VerifyClaims, *rest.ErrorResponse) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "VerifyJWT", tokenString)
	ret0, _ := ret[0].(verify_jwt.VerifyClaims)
	ret1, _ := ret[1].(*rest.ErrorResponse)
