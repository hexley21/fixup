...
// Source: internal/catalog/repository/subcategory.go
//
// Generated by this command:
//
//	mockgen -source=internal/catalog/repository/subcategory.go -destination=internal/catalog/repository/mock/mock_subcategory.go
//
...
func (m *MockSubcategory) WithTx(q postgres.PGXQuerier) repository.Subcategory {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "WithTx", q)
	ret0, _ := ret[0].(repository.Subcategory)
	return ret0
}

// WithTx indicates an expected call of WithTx.
func (mr *MockSubcategoryMockRecorder) WithTx(q any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "WithTx", reflect.TypeOf((*MockSubcategory)(nil).WithTx), q)
}
